This is a backend project made using NodeJS, Express Js and Mongo DB. This offers a simple API, more like a template which focuses on retrieving user-specific content. <br>
